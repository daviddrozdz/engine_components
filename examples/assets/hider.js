import{E as y}from"./index-H1X3kY-x.js";import{S as k}from"./stats.min-GTpOrGrX.js";import{T as x,L as r,m as l}from"./index-ByMLC5eT.js";import{C,W as F,S as I,d as L,a as v,G as j,F as E,I as M,H as R,c as $}from"./index-Dge8UBVh.js";import"./_commonjsHelpers-Cpj98o6Y.js";const B=document.getElementById("container"),e=new C,N=e.get(F),t=N.create();t.scene=new I(e);t.renderer=new L(e,B);t.camera=new v(e);e.init();t.camera.controls.setLookAt(12,6,8,0,0,-10);t.scene.setup();const O=e.get(j);O.create(t);t.scene.three.background=null;const b=e.get(E),T=await fetch("https://thatopen.github.io/engine_components/resources/small.frag"),U=await T.arrayBuffer(),_=new Uint8Array(U),i=b.load(_);t.scene.three.add(i);const A=await fetch("https://thatopen.github.io/engine_components/resources/small.json");i.setLocalProperties(await A.json());const d=e.get(M),G=await fetch("https://thatopen.github.io/engine_components/resources/small-relations.json"),H=d.getRelationsMapFromJSON(await G.text());d.setRelationMap(i,H);const f=e.get(R),o=e.get($);o.byEntity(i);await o.bySpatialStructure(i,{isolate:new Set([y])});const a=new k;a.showPanel(2);document.body.append(a.dom);a.dom.style.left="0px";a.dom.style.zIndex="unset";t.renderer.onBeforeUpdate.add(()=>a.begin());t.renderer.onAfterUpdate.add(()=>a.end());x.init();const g={},q=Object.keys(o.list.spatialStructures);for(const n of q)g[n]=!0;const h={},D=Object.keys(o.list.entities);for(const n of D)h[n]=!0;const s=r.create(()=>l`
